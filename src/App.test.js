...
test("App renders, fetches show, and displays show data", async () => {
  ...
  expect(getByText(/season 1/i)).toBeVisible();

  expect(getByText(/season 2/i)).toBeInTheDocument();
  expect(getByText(/season 2/i)).toBeVisible();

  expect(getByText(/season 3/i)).toBeInTheDocument();
  expect(getByText(/season 3/i)).toBeVisible();

  expect(getByText(/season 4/i)).toBeInTheDocument();
  expect(getByText(/season 4/i)).toBeVisible();
